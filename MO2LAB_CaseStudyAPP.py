...
#   lastName - String Value, stores last name of student via user input
#   firstName - String Value, stores first name of student via user input
#   GPA - Float Value, stores the student's GPA via user input
